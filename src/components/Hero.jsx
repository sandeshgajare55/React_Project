      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Sandesh Gajare</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A passionate and results-driven software engineer with a strong
            background in Java, Python, SQL, and good in the Django framework.<br/>
            I bring over 1.2 years of experience working with cutting-edge
